...
def node(node_id: str, inputs: Dict[str, str] = None, type: str = "function", label: str = None, **kwargs):
    ...
    def decorator(func):
        func._node_config = {"id": node_id, "inputs": inputs or {}, "type": type, "label": label, **kwargs}
        return func
...
def output_node(
    node_id: str, inputs: Dict[str, str] = None, label: str = None, min: float = None, max: float = None, **kwargs
):
