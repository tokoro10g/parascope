...
export function createBaseXAxis(ctx: StrategyContext, type: 'value' | 'category') {
    return {
        type,
...
export function createBaseYAxis(ctx: StrategyContext, type: 'value' | 'category', scale: boolean) {
    return {
        type,
        name: ctx.label,
        nameLocation: 'end',
