...
interface UseUrlSyncProps {
    ...
    setCalculationInputs: React.Dispatch<React.SetStateAction<Record<string, string>>>;
...
export function useUrlSync({
    ...
    }, [searchParams, nodes, initialLoadDone, setCalculationInputs, setInitialLoadDone]);
