...
async def seed_database(session: AsyncSession):
    ...
    node_nested_q = Node(
        ...
        inputs=[
            {"key": "Density (rho) [kg/m3]"},
            {"key": "Velocity (v) [m/s]"},
        ],
        outputs=[{"key": "Dynamic Pressure (q) [Pa]"}],
        position_x=500,
        position_y=400,
    ...
    node_nested_rocket = Node(
        ...
        inputs=[
            {"key": "Isp [s]"},
            {"key": "Initial Mass (m0) [kg]"},
            {"key": "Final Mass (mf) [kg]"},
        ],
        outputs=[{"key": "Delta-V [m/s]"}],
        position_x=800,
        position_y=400,
    ...
    node_margin_func = Node(
        ...
        inputs=[{"key": "Achieved_DV"}, {"key": "Target_DV"}],
        outputs=[{"key": "Margin"}, {"key": "Is_Feasible"}],
        position_x=1200,
        position_y=500,
        data={
