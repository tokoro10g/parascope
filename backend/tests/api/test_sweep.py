...
async def test_sweep_execution(client: AsyncClient):
    ...
    nodes = [
        {"id": v_id, "type": "constant", "label": "V", "position_x": 0, "position_y": 0, "data": {"value": 10}, "outputs": [{"key": "value"}]},
        {"id": a_id, "type": "constant", "label": "A", "position_x": 0, "position_y": 100, "data": {"value": 45}, "outputs": [{"key": "value"}]},
        {
            "id": func_id, "type": "function", "label": "Traj", "position_x": 200, "position_y": 50,
            "data": {"code": "dist = v * math.cos(math.radians(a))"},
            "inputs": [{"key": "v"}, {"key": "a"}],
            "outputs": [{"key": "dist"}]
        },
        {"id": out_id, "type": "output", "label": "Result", "position_x": 400, "position_y": 50, "inputs": [{"key": "value"}]}
    ]
    conns = [
